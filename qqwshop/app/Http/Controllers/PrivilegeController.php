...
class PrivilegeController extends Controller
{
    public function index(){
        ...
        return view("admin.admin_privilege",[
            'roleList'=>$roleList,
    ...
    public function store(PrivilegeRequest $req){
        ...
        return redirect()->route('privilege.index')->with('tips','添加成功!');
    }
    ...
    public function update(Request $req,$id){
        ...
        return redirect()->route('privilege.index')->with('tips','修改成功!');

    }
    public function destroy($id){
        Privilege::pri_delete($id);
        return redirect()->route('privilege.index')->with('tips','删除成功!');
    }
