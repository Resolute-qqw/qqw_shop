...
$(function () {
    ...
    var step = {
        ...
        Creat_Table: function () {
            ...
            var arraySkuId = new Array();//盛放每组选中的sku_id
            ...
            $.each(SKUObj, function (i, item){
                ...
                $("." + itemName + " input[type=checkbox]:checked").each(function (){
                    sku_id.push($(this).prev().val());

                });
                arraySkuId.push(sku_id);
            ...
            if (bCheck == true) {
                ...
                var sku_zuhe = step.doExchange(arraySkuId);
                
                $("#sku_zuhe").val(JSON.stringify(sku_zuhe))
