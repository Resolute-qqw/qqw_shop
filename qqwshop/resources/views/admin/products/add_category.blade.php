		...
		<div id="add_brand" class="clearfix">
			<form action="{{route('admin.category.store')}}" method="post" enctype="multipart/form-data">
				...
				<div class="left_add">
					...
					<ul class="add_conent">
						<li>
							<input type="button" id="add_cate" value="添加分类">
						</li>
						<li class="clearfix" id="cate_name">
							<label class="label_name"><i>*</i>分类名称：</label>
							<input type="text" name="cate_name[]">
						</li>
						
						<li class="clearfix">
							<label class="label_name"><i>*</i>父级目录：</label>
...
<script type="text/javascript">
	...
	var cate_str = `<input type="text" name="cate_name[]">`;
	$("#add_cate").click(function(){
		$("#cate_name").append(cate_str)
	})
</script>