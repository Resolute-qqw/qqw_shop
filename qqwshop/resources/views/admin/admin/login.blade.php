...
<body class="login-layout Reg_log_style">
	...
	<div class="loginbody">
		<div class="login-container">
			<div class="center">
				<img src="/admin_style/images/logo1.png" />
			</div>
							...
							<form action="{{route('admin.dologin')}}" method="POST">
								...
								<fieldset>
									<ul>
										...
										<li class="frame_style form_error"><label class="password_icon"></label><input name="password" sign="密码" type="password" id="userpwd" /><i>密码</i></li>
									...
									<div class="clearfix">
										...
										<input type="submit" class="width-35 pull-right btn btn-sm btn-primary" id="login_btn" value="提交">
									</div>
	...
	$('#login_btn').on('click', function () {
		...
		$("input[type$='text'],input[type$='password']").each(function (n) {
			if ($(this).val() == "") {
				...
				layer.alert(str += "" + $(this).attr("sign") + "不能为空！\r\n", {
					title: '提示框',
					icon: 0,
				});
				num++;
		...
		if (num > 0) { return false; }
			...
			location.href = "{{route('admin.dologin')}}";
			layer.close(index);
		}
