...
<div class="clearfix">
     ...
     <div class="type_title">管理员信息 </div>
      <div class="xinxi">
        <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">用户名： </label>
          <div class="col-sm-9"><input type="text" name="username" value="{{$info->username}}" class="col-xs-7 text_info" disabled="disabled">
          &nbsp;&nbsp;&nbsp;<a href="javascript:ovid()" onclick="change_Password()" class="btn btn-warning btn-xs">修改密码</a></div>
          
          </div>
          <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">用户备注： </label>
          <div class="col-sm-9" > <span>{{$info->remarks}}</span></div>
 ...
 <!--修改密码样式-->
         <div class="change_Pass_style" id="change_Pass">
            <form action="{{route('admin.update.pwd')}}">
            <ul class="xg_style">
             <li><label class="label_name">原&nbsp;&nbsp;密&nbsp;码</label><input name="原密码" type="password" name="old_password" class="" id="password"></li>
             <li><label class="label_name">新&nbsp;&nbsp;密&nbsp;码</label><input name="新密码" type="password" name="password" class="" id="Nes_pas"></li>
             <!-- <li><label class="label_name">确认密码</label><input name="再次确认密码" type="password" class="" id="c_mew_pas"></li> -->
             <li><label class="label_name"></label><input type="submit" id="c_mew_pas" value=""></li>
            </ul>
