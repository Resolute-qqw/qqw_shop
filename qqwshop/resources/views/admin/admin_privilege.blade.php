...
<body>
 <div class="margin clearfix">
   <div class="border clearfix">
       <span class="l_f">
        <a href="{{route('privilege.create')}}" id="Competence_add" class="btn btn-warning" title="添加权限"><i class="fa fa-plus"></i> 添加权限</a>
			...
			<tr>
             ...
             <tbody>
			  ...
			  <tr>
				...
				<td>{{$v->describe}}</td>
				<td>
                 <a title="编辑" href="{{route('privilege.edit',['id'=>$v->id])}}"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>        
                 <a title="删除"  href="{{route('privilege.destroy',['id'=>$v->id])}}"  class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
				</td>
			   </tr>
				@endforeach
		      </tbody>
