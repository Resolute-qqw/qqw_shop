...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/business_style/css/pages-register.css" />
</head>
...
<body>
	<div class="register py-container ">
		...
		<div class="registerArea">
			<h3>商家入驻申请<span class="go">我有账号，去<a href="{{route('business.login')}}">登陆</a></span></h3>
			<div class="info">
				<form action="{{route('business.dologin')}}" method="post" class="sui-form form-horizontal">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="m1" type="checkbox" value="2" checked=""><span>同意协议并注册  <a href="{{route('business.sampling')}}">《品优购商家入驻协议》</a></span>
						</div>
					</div>
					<div class="control-group">
...
<script type="text/javascript" src="/business_style/js/pages/register.js"></script>
</body>
