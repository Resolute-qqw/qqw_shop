...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/goods_style/css/pages-item.css" />
	<link rel="stylesheet" type="text/css" href="/goods_style/css/pages-zoom.css" />
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom"><img width="400" height="400" jqimg="/uploads/{{$images_one->goods_image}}" src="/uploads/{{$images_one->goods_image}}" /></span>
						</div>
						<!--下方的缩略图-->
						<div class="spec-scroll">
							...
							<div class="items">
								<ul>
									@foreach($images as $v)
									<li><img src="/uploads/{{$v->goods_image}}" bimg="/uploads/{{$v->goods_image}}" onmousemove="preview(this)" /></li>
									@endforeach
								</ul>
							</div>
							<a class="next">&gt;</a>
						...
						<div class="clearfix choose">
							<div id="specification" class="summary-wrap clearfix">
								...
								<dl>
									<dt>
										<div class="fl title">
											<input  name="sku_name[]" type="hidden" value="{{$v->sku_name}}">
											<i>{{$v->sku_name}}</i>
										</div>
									</dt>
								<dd name="fa_dd"> 
						...
						<div id="index" class="tab-pane active">
							...
							<ul class="goods-list unstyled">
								<li>
									<div class="list-wrap">
										<div class="p-img">
											<img src="/goods_style/img/_/part01.png" />
										</div>
										<div class="attr">
								...
								<li>
									<div class="list-wrap">
										<div class="p-img">
											<img src="/goods_style/img/_/part02.png" />
										</div>
										<div class="attr">
											<em>Apple苹果iPhone 6s (A1699)</em>
										</div>
								...
								<li>
									<div class="list-wrap">
										<div class="p-img">
											<img src="/goods_style/img/_/part03.png" />
										</div>
										<div class="attr">
											<em>Apple苹果iPhone 6s (A1699)</em>
										</div>
					...
					<div class="clearfix fitting">
						...
						<div class="good-suits">
							<div class="fl master">
								<div class="list-wrap">
									<div class="p-img">
										<img src="/goods_style/img/_/l-m01.png" />
									</div>
									<em>￥5299</em>
									<i>+</i>
								</div>
							...
							<div class="fl suits">
								<ul class="suit-list">
									<li class="">
										<div id="">
											<img src="/goods_style/img/_/dp01.png" />
										</div>
										<i>Feless费勒斯VR</i>
									...
									<li class="">
										<div id=""><img src="/goods_style/img/_/dp02.png" /> </div>
										<i>Feless费勒斯VR</i>
										<label data-toggle="checkbox" class="checkbox-pretty">
									...
									<li class="">
										<div id=""><img src="/goods_style/img/_/dp03.png" /></div>
										<i>Feless费勒斯VR</i>
										<label data-toggle="checkbox" class="checkbox-pretty">
									...
									<li class="">
										<div id=""><img src="/goods_style/img/_/dp04.png" /></div>
										<i>Feless费勒斯VR</i>
										<label data-toggle="checkbox" class="checkbox-pretty">
				...
				<div class="like-list">
					<ul class="yui3-g">
						<li class="yui3-u-1-6">
							<div class="list-wrap">
								<div class="p-img">
									<img src="/goods_style/img/_/itemlike01.png" />
								</div>
								<div class="attr">
						...
						<li class="yui3-u-1-6">
							<div class="list-wrap">
								<div class="p-img">
									<img src="/goods_style/img/_/itemlike02.png" />
								</div>
								<div class="attr">
						...
						<li class="yui3-u-1-6">
							<div class="list-wrap">
								<div class="p-img">
									<img src="/goods_style/img/_/itemlike03.png" />
								</div>
								<div class="attr">
									<em>DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本</em>
								</div>
						...
						<li class="yui3-u-1-6">
							<div class="list-wrap">
								<div class="p-img">
									<img src="/goods_style/img/_/itemlike04.png" />
								</div>
								<div class="attr">
									<em>DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本</em>
								</div>
						...
						<li class="yui3-u-1-6">
							<div class="list-wrap">
								<div class="p-img">
									<img src="/goods_style/img/_/itemlike05.png" />
								</div>
								<div class="attr">
									<em>DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本</em>
								</div>
						...
						<li class="yui3-u-1-6">
							<div class="list-wrap">
								<div class="p-img">
									<img src="/goods_style/img/_/itemlike06.png" />
								</div>
								<div class="attr">
									<em>DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本</em>
								</div>
