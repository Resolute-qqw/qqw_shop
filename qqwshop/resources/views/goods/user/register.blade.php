...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/goods_style/css/pages-register.css" />
</head>
...
<body>
	<div class="register py-container ">
		...
		<div class="registerArea">
			<h3>注册新用户<span class="go">我有账号，去<a href="{{route('user.login')}}">登陆</a></span></h3>
			<div class="info">
				<form class="sui-form form-horizontal"  action="{{route('user.doregister')}}" method="post">
					@csrf
					<div class="control-group">
						<label class="control-label">用户名：</label>
						<div class="controls">
							<input type="text" name="login_name" placeholder="请输入你的用户名" class="input-xfat input-xlarge">
						</div>
					</div>
					<div class="control-group">
						<label for="inputPassword" class="control-label">登录密码：</label>
						<div class="controls">
							<input type="password" name="login_pwd" placeholder="设置登录密码" class="input-xfat input-xlarge">
						</div>
					</div>
					{{-- <div class="control-group">
...
<script type="text/javascript" src="/goods_style/js/plugins/jquery-placeholder/jquery.placeholder.min.js"></script>
<script type="text/javascript" src="/goods_style/js/pages/register.js"></script>
</body>
