...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/goods_style/css/pages-login.css" />
</head>
				...
				<div class="loginform">
					...
					<div class="tab-content tab-wraped">
						...
						<div id="profile" class="tab-pane  active">
							...
							<form class="sui-form" action="{{route('user.dologin')}}" method="post">
								@csrf
							...
							<div class="otherlogin">
								<div class="types">
									<ul>
										<li><img src="/goods_style/img/qq.png" width="35px" height="35px" /></li>
										<li><img src="/goods_style/img/sina.png" /></li>
										<li><img src="/goods_style/img/ali.png" /></li>
										<li><img src="/goods_style/img/weixin.png" /></li>
									</ul>
								</div>
								<span class="register"><a href="{{route('user.register')}}">立即注册</a></span>
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript" src="/goods_style/js/pages/login.js"></script>
</body>
